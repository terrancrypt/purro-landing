...
const DEFAULT_GLOW_COLOR = "0, 201, 164"; // green glow
const MOBILE_BREAKPOINT = 768;

const cardData: BentoCardProps[] = [
  {
    color: "#06211d",
    title: "One wallet for Hyperliquid & HyperEVM",
    description: "Seamless accounts across HL & HyperEVM",
    label: "Wallet",
  },
  {
    color: "#06211d",
    title: "40% swap fees back in PURRO",
    description: "Earn token rebates on every swap",
    label: "Rewards",
  },
  {
    color: "#06211d",
    title: "Swap, stake, bridge in one place",
    description: "Unified actions with best routes",
    label: "Actions",
  },
  {
    color: "#06211d",
  ...
  {
    color: "#06211d",
    title: "Dev‑ready SDKs for HL apps",
    description: "Simple APIs for wallet & payments",
    label: "SDK",
  },
  {
    color: "#06211d",
    title: "Multi‑chain support",
    description: "Hyperliquid today, more chains tomorrow",
    label: "Chains",
  },
];
      ...
      <style>
        {`
          ...
          .card--border-glow:hover {
            box-shadow: 0 4px 20px rgba(0, 92, 74, 0.35), 0 0 30px rgba(${glowColor}, 0.2);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px rgba(0, 92, 74, 0.2), 0 0 30px rgba(${glowColor}, 0.2);
          }
